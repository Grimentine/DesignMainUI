...
public class GameActivity extends AppCompatActivity {
    ...
    private void setQuestion(int qID) { //กำหนดข้อคำถามและเฉลยในแต่ละข้อ
        ...
        if (qID == 2) {
            ...
            choice.add("สุนัข");
            choice.add("วัว");
            choice.add("แมว");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 3) {
            ...
            choice.add("ลิง");
            choice.add("ช้าง");
            choice.add("กระทิง");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 4) {
            ...
            choice.add("เป็ด");
            choice.add("สุนัข");
            choice.add("แพะ");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 6) {
            ...
            choice.add("ลา");
            choice.add("ไก่");
            choice.add("ยีราฟ");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 7) {
            ...
            choice.add("เสือดำ");
            choice.add("สิงโต");
            choice.add("หมี");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 8) {
            ...
            choice.add("ผีเสื้อ");
            choice.add("แมลงวัน");
            choice.add("ยุง");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
        ...
        if (qID == 9) {
            ...
            choice.add("แรด");
            choice.add("หมู");
            choice.add("ปลา");//สัตว์ที่จะให้แสดง
            Collections.shuffle(choice);//กำหนดให้แรนดอม
            btn1.setText(choice.remove(0));
            btn2.setText(choice.remove(0));
            btn3.setText(choice.remove(0));
